...
test_pre_log_count_withlog_path = common_path + r'/data/feature/test_pre_usrid_log_count.csv'

def kNN_pre_without(X_path, Y_path, x_test_path, y_test_path):
    # 读取有log的usrid的agg
    ...
    y_usrid_pre.columns=['USRID','merge_evt3']
    print('writing')
